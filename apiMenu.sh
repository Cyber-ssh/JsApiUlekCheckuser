...
carregar_cache() {
    arquivo='/root/jsApiCheckuser/porta.txt'
    if [[ -e "$arquivo" ]]; then
...
while true; do
    ...
    echo -e "\nSelecione uma opção:"
    echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33m 01 - $acao api"
    echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33m 02 - Sobre"
    echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33m 00 - Sair do menu"
...
[Service]
Type=simple
ExecStart=/root/jsApiCheckuser/init.sh
Restart=always
